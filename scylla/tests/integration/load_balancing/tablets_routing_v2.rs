...
/// in schema, not in `system.tablets`; it merely rotates the replica list of this payload so that
/// the leader comes first, and a Raft re-election can move it at any time.
